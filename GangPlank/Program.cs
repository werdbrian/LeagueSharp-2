...
//      {
        public const string CharName = "GangPlank";
        ...
        private static void OnLoad(EventArgs args)
        {
            ...
            Config.SubMenu("drawing").AddItem(new MenuItem("EDraw", "Draw (E) Range").SetValue(new Circle(true, System.Drawing.Color.FromArgb(255, 128, 0, 128))));
